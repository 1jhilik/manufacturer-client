    ...
    return (
        <div  className='px-16'> 
            <div className='about-page'>
                <h1>Hello</h1>
                <h1>I'm <span className='text-primary font-bold'>Roksana Akter Jhilik</span></h1>
                ...
                <br />
                <p className='text-white font-bold text-2xl'>Email Address: roksanajhilik@gmail.com</p>
            </div>
